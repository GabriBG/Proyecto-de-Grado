...
<div class="row">
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <h4>Actualizar Docente</h4>
@if (count($errors)>0)
...
<form action="{{route('docente.update',$personas->id)}}" method="post">
{{Form::token()}}
@method('PUT')
...
{!! Form::model($personas, ['route' => ['docente.update', $personas], 'method' => 'put']) !!}

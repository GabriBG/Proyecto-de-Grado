...
<form action="{{route('grupo.update',$grupos->id)}}" method="post">
    {{Form::token()}}
    @method('PUT')
...
{!!Form::close()!!}
<a class="btn btn-danger" href="{{ route('grupo.index') }}"><span class="glyphicon glyphicon-remove"></span> Atrás</a>        </div>
    </div>
</div>
@endsection
